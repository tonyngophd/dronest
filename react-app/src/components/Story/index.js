...
export function StoryTopBox() {
  ...
  useEffect(() => {
    if (!users) return;
    setUsersWithRecentPosts(users.filter((user) => user.ownPosts.length));
  }, [users]);
  useEffect(() => {
    updateStories(
  ...
  return (
    <>
      ...
      <div className="feed_container story-topbox-container">
...
export function StoriesFullPageComponent({ stories = [] }) {
  return (
    <div className="story-fullpage-container">
      <Stories stories={stories} width={600} height={800} />
    </div>
  );
}
export function StoriesFullPage() {
  ...
  return (
    <div className="story-fullpage-container">
                ...
                <div key={nanoid()}>
                  {index === currentUser ? (
                    ...
                    <div className="stories-lineup-inactive-user-div">
                      <img
                        src={usersWithRecentPosts[index].profilePicUrl}
                        alt="user-icon"
                        className="story-profile-image"
                        style={{
                          width: "60px",
                      ...
                      />
                      <div
                        className="feed_post-username story-username-div"
                        style={{ color: "white" }}
                      >
      ...
      <div
        className="fullpage-stories-close"
